...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                <li><span class="text-muted">Welcome, <%= session.getAttribute("userName") %></span></li>
    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number" style="color:#16a34a;"><%= request.getAttribute("availableAnimals") %></div>
                    <div class="stat-label">Available</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number" style="color:#2563eb;"><%= request.getAttribute("adoptedAnimals") %></div>
                    <div class="stat-label">Adopted</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number" style="color:#ea580c;"><%= request.getAttribute("pendingApplications") %></div>
                    <div class="stat-label">Pending Applications</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number" style="color:#dc2626;"><%= request.getAttribute("pendingUsers") %></div>
                    <div class="stat-label">Pending Users</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number" style="color:#7c3aed;"><%= request.getAttribute("totalAdoptions") %></div>
            ...
            <div class="card mb-3">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        <% List<User> pendingUsers = (List<User>) request.getAttribute("pendingUsersList");
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        <% List<AdoptionApplication> apps = (List<AdoptionApplication>) request.getAttribute("recentApplications");
                           if (apps != null) {
                               int count = 0;
